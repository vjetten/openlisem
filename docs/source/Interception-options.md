<p align="center">
  <img width="547" height="439" src="https://github.com/vjetten/openlisem/blob/imgs_wiki/docs/imgs/input_interception_options.png">
</p>
...
📝 **this section needs to be revised with the use of NDVI timeseries and a smoother way of including interception parameters for complex landuse**