...
*/
   ...
   // QString runoffFractionMapFileName;
    ...
    OutQ, OutQn, OutQinKW, OutS, OutSn, OutSin, OutSAFO, OutWHAFO, OutFW, OutSS, Outerosion, Outchtheta, Outchlw;
...
//                         cTMap *_KD,cTMap *_poro,cTMap *_rhob,cTMap *_kr,cTMap *_Qin, cTMap *_Sin,cTMap *_Q,cTMap *_Alpha,cTMap *_Qpn);
    ...
    void KinematicPestAdsorbed(QVector <LDD_COORIN> _crlinked_,
                           ...
                           double rho);
    void KinematicPestDissolvedComplex(QVector <LDD_COORIN> _crlinked_,
                   cTMap *_LDD, cTMap *_Qn, cTMap *_Qpwn, cTMap *_DX,
                   cTMap *_Alpha, cTMap *_Q, cTMap *_Qpw, double _kfilm);
