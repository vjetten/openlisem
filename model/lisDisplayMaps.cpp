...
//       AddComboMap(0,"Diagonal Discharge","l/s",Qdiag,LegendMap[cl],Legend[cl],false,false,1.0, 0.01);
    ...
    // cl=6;
    // if (InfilMethod != K2D_METHOD_KIN) {
    //     AddComboMap(0,"Flow Velocity U","m/s",Uflood,LegendMap[cl],Legend[cl],false,true,1.0, 0.001);
    //     AddComboMap(0,"Flow Velocity V","m/s",Vflood,LegendMap[cl],Legend[cl],false,true,1.0, 0.001);
    // }
    cl = 1;
    ...
    if (SwitchKinematic2D == K2D_METHOD_DYN || SwitchKinematic2D == K2D_METHOD_KINDYN) {
        ...
        AddComboMap(0,"Max flow","m3/s",Qm3max,LegendMap[cl],Legend[cl],false,false,1.0,0.01);
        cl = 5;
