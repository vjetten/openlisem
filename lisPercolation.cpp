...
void TWorld::cell_Channelinfow2(int r, int c)
{
    ...
    if (CHin1 < 1e-10) CHin1 = 0.0;
    if (CHin2 < 1e-10) CHin2 = 0.0;
    if (theta <= thetar) CHin1 = 0.0;
    if (theta2 <= thetar2) CHin2 = 0.0;
    if (CHin1 == 0 && CHin2 == 0)
        return;
    ...
    // update channel side inflow, sometimes nan occurs, piss of!
