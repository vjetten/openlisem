...
//        if (p1.compare("D50 for distribution")==0)          distD50 = p.toDouble();
    //    if (p1.compare("OF method")==0)                       OF_Method     = iii;
      ...
      //  if (p1.compare("Estimate d90")==0)                    SwithEstimated90     = iii == 1;
        ...
        if (p1.compare("Enable Deposition") == 0)    SwitchDeposition = iii == 1;
        if (p1.compare("Enable Compaction") == 0)    SwitchCompaction = iii == 1;
        if (p1.compare("Enable Seismic") == 0)          SwitchSeismic = iii == 1;
