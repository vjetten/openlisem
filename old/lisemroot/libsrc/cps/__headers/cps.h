...
//=====------- _spatial and _nonspatial vars ----=====//
#define _spatial(type, varName) \
  MEM_HANDLE varName={NULL}; \
  CpsDeclare(#varName, &varName, CR_##type, CPS_SPATIAL, CPS_STATIC /*CPS_NONSTATIC*/)
...
#define _nonspatial(type, varName) \
	  type varName;CpsDeclare(#varName, &varName, CR_##type, \
                             CPS_NONSPATIAL, CPS_STATIC /*CPS_NONSTATIC*/)

//=====------- STATIC _spatial and _nonspatial vars ----=====//
...
/* should be defined in cpslang.c: */
