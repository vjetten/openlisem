...
// *****************************************************************************
      ...
      //NOTE:
      //NUTRIENTS IN SUSPENSION CALCULATED IN LisPMCNUTerosdepo

      // IMPORTANT:
      // IT IS ASSUMED THAT NUTRIENT SOURCES ARE ONLY ON FIELD SURFACES
      // SO WHEEL TRACKS AND CHANNELS are not a source of NUTRIENTS
...
//------------------------------------------------------------------------------
      ...
      // no more infiltration then there is in solution
/*
      ...
      //total nuts infiltrated in the area in kg/m2
      //MOVED TO NUTmassbal
*/
//------------------------------------------------------------------------------
