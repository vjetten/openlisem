...
public:
    ...
    void setupUi(QWidget *ifacebasicClass)
    {
        ...
        ifacebasicClass->resize(625, 276);
        ...
        layoutWidget->setGeometry(QRect(118, 11, 191, 110));
        ...
        layoutWidget1->setGeometry(QRect(10, 190, 601, 81));
        ...
        widget->setGeometry(QRect(120, 130, 140, 34));
