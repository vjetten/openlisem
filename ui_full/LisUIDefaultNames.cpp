...
//    namelist[i++].name = QString("Include channel baseflow");
    ...
    namelist[i].value = QString("58.85");
    namelist[i++].name = QString("Daily ET latitude");
...
//    namelist[i++].name = QString("SoilDepth2 calibration");
  ...
  //  namelist[i++].name = QString("Timeseries as PCRaster");
    ...
    namelist[i].value = QString("8");
    namelist[i++].name = QString("Font size");
    ...
    namelist[i].value = QString("1");
    namelist[i++].name = QString("Soil physics");
